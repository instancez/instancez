...
//   INSTANCEZ_SECRET_KEY           secret key the spec logs in with
...
const secretKey = process.env.INSTANCEZ_SECRET_KEY || "inz_secret_e2e";
const publishableKey = process.env.INSTANCEZ_PUBLISHABLE_KEY || "inz_publishable_e2e";
