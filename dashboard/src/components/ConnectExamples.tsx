...
// Snippets reference the publishable key as a variable rather than inlining the
// raw token — shorter, and the value is one copy-click away in the panel above.
...
client, err := supabase.NewClient("${url}", publishableKey, &supabase.ClientOptions{})
