...
const ANON_KEY = import.meta.env.VITE_INSTANCEZ_ANON_KEY ?? 'public-anon-placeholder'
...
// value is only wired through VITE_INSTANCEZ_ADMIN_KEY for the compose
// demo — a production deployment must never expose an admin key to the
// browser.
export const DEV_ADMIN_KEY = import.meta.env.VITE_INSTANCEZ_ADMIN_KEY || ''
